...
$connectionID  =   mysqli_connect("localhost", "root" ,"sahy", "unit-1");

$select = mysqli_query($connectionID, "SELECT * FROM `answers` WHERE `answer1` = '".$_POST['answer1']."'") or exit(mysqli_error($connectionID));
